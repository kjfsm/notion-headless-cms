/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fe32e2991d39d90a45ff8e93d3a926b0)
// Runtime types generated with workerd@1.20260611.1 2026-04-22 nodejs_compat
interface __BaseEnv_Env {
	DOC_CACHE: KVNamespace;
	IMG_BUCKET: R2Bucket;
	NOTION_TOKEN: string;
	SYNC_COORDINATOR: DurableObjectNamespace<import("./workers/app").SyncCoordinatorDO>;
	REALTIME_HUB: DurableObjectNamespace<import("./workers/app").RealtimeHubDO>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./workers/app");
		durableNamespaces: "SyncCoordinatorDO" | "RealtimeHubDO";
	}
