...
export function Callout({ block, className }: BlockComponentProps<CalloutBlockObjectResponse>) {
  ...
  return (
    <CalloutCard
      ...
      className={cn("my-3 grid-cols-[calc(var(--spacing)*6)_1fr] gap-x-3", colorClass, className)}
      icon={
        <span
        ...
        >
          ...
          {icon?.type === "file" ? <img src={icon.file.url} alt="" className="size-5" /> : null}
        </span>
      }
    >
