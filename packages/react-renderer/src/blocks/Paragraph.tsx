...
export function Paragraph({ block, className }: BlockComponentProps<ParagraphBlockObjectResponse>) {
  return (
    <div className={cn("my-2", notionBlockColorClass(block.paragraph.color), className)}>
